...
from Post.models import Post,Comment,RepComment,NewsLetter,visitors
...
def ReadMore(request,slug,category):
    ...
    if not request.user.is_superuser:
        click=visitors.objects.create(blog=sigle_blog,click="clicked")
